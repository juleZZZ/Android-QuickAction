 ...
 */
package com.alhneiti.QuickAction;
...
import com.alhneiti.android_quickaction.R;

/**
 * A {@link QuickActionImageGrid} is an implementation of a {@link QuickActionWidget}
 ...
 */
public class QuickActionImageGrid extends QuickActionWidget {
    private GridView mGridView;

    public QuickActionImageGrid(Context context) {
        super(context);
        ...
        mGridView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View view, ViewGroup parent) {
                ...
                if (view == null) {
                    ...
                    imageView = (ImageView) inflater.inflate(R.layout.gd_quick_action_grid_image_item, mGridView, false);
                }
    ...
    private OnItemClickListener mInternalItemClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            getOnQuickActionClickListener().onQuickActionClicked(QuickActionImageGrid.this, position);
